...
import { CONTRIBUTOR_NAV_ITEMS } from '../../../constants/contributorNav';
...
export const ContributorSidebar: React.FC<ContributorSidebarProps> = ({
  isCollapsed,
  onToggleCollapse,
  isMobileOpen,
  onCloseMobile,
  ...
  const sidebarContent = (
    <div className="h-full flex flex-col justify-between bg-[#0B1D33] text-slate-200 border-r border-[#152d4a] select-none">
      ...
      <div>
          ...
          <div className="flex items-center gap-3 overflow-hidden">
            ...
            {!isCollapsed && (
              <div className="flex flex-col min-w-0 transition-opacity duration-200">
                ...
                <span className="text-[10px] uppercase tracking-wider font-semibold text-teal-400 truncate">
                  Data Contributor
                </span>
              </div>
            )}
        ...
        >
          {CONTRIBUTOR_NAV_ITEMS.map((item) => {
              ...
              >
                {({ isActive }) => (
                  <>
                    ...
                    {isActive && (
                      <span className="absolute left-0 top-1.5 bottom-1.5 w-1 bg-teal-300 rounded-r-full" />
                    )}
                  </>
                )}
              </NavLink>
      ...
      <div className="p-3 border-t border-[#152d4a] bg-[#081525] space-y-2">
        ...
        <div
          ...
          title="Demo Contributor (Data Contributor)"
        >
          <div className="w-8 h-8 rounded-full bg-teal-800 border border-teal-400/30 flex items-center justify-center text-white shrink-0">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            title="Logout of Data Contributor Portal"
